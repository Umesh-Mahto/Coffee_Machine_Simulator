        ...
        while(true) {
            ...
            switch (n) {
                case 1:
                    ...
                    switch(chooseCoffee){
                        case 1:System.out.println(coffeeMachineObj.espressoPurchase(4,250,0,16));
                            break;

                        case 2:System.out.println(coffeeMachineObj.lattePurchase(7,350,75,20));
                            break;
                        case 3:System.out.println(coffeeMachineObj.CappuccinoPurchase(6,200,100,12));
                            break;
...
////////////////////////////////////////////////////////////////////////////////////////////
                case 2:
                    ...
                    switch (coffeeIngredient) {
                        case 1:
                            coffeeMachineObj.CoffeeMachine();
                            break;

                        case 2:
                            System.out.println("Give amount of water in ML:");
                            int water = sc.nextInt();
                            System.out.println("Give amount of milk in ML:");
                            int milk = sc.nextInt();
                            System.out.println("Give amount of beans:");
                            int beans = sc.nextInt();
                            coffeeMachineObj.fillCoffeeIngredient(water, milk, beans);
                            break;
                        case 3: coffeeMachineObj.showAmount();
                            break;
                        default:System.out.println("Wrong input...Sorry!!!");
                    }
                    break;
                case 3:coffeeMachineObj.showAnalytics();
                    break;
                case 4: return;
